...
function AccountCompanyList () {
    ...
    const fetchEmployee = async () => {
        const eUrl = "http://localhost:8000/employees"
        ...
        className="
            ...
            <tbody className="opaque-list">
                {employee.map((employee) => {
                    return (
                    <tr key={employee.id} value={employee.id} className="text-lg text-center text-gray-500 dark:text-darktext opacity-80">
