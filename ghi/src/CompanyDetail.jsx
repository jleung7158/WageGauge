      ...
      >
              ...
              return (
                ...
                >
                  ...
                  <img
                    alt="companies"
                    src={circleRight}
                    className="ml-4 w-[30px] opacity-50"
                  />
                </button>
              );
            })}
        ...
        >
          {isFigureOpen ? (
            <div>
              <div
                className={`h-full transition-all delay-500 duration-2000 animate-slide-in ${
                  isFigureOpen ? "opacity-100" : "opacity-0"
                }`}
              >
            ...
            <div
              className={`flex flex-col ${
                isFigureOpen ? "opacity-0" : "opacity-100"
              }`}
            >
              {isFigureOpen ? (
                ""
